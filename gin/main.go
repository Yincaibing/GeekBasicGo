...
import (
	...
	"github.com/Yincaibing/GeekBasicGo/webook/inter/web"
	"github.com/Yincaibing/GeekBasicGo/webook/inter/web/middleware"
...
func initDB() *gorm.DB {
	db, err := gorm.Open(mysql.Open("root:ycbpassword@tcp(127.0.0.1:3307)/webook"))
	if err != nil {
		// 我只会在初始化过程中 panic
